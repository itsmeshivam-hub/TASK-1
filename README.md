...
<head>
    ...
    <title>Shivam Tiwari | First Webpage</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <h2>About Me</h2>
            <p>
                Hi! I'm <strong>Shivam Tiwari</strong>, an aspiring web developer currently learning 
    ...
    <script>
        function showMessage() {
            alert("Hello! Welcome to Shivam's webpage 🎉");
        }
    </script>
